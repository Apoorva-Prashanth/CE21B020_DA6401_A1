...
class Optimizer:
    ...
    def backward_pass(self, X, Y):
        ...
        dA = (activations[-1] - Y)  # MSE derivative
        dW, db = [], []
...
def train(args):
    ...
    for epoch in range(config.epochs):
        ...
        wandb.log({"training_loss": train_loss, "validation_loss": val_loss, "epoch": epoch + 1, "accuracy": val_acc})
